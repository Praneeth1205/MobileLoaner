...
import com.loaner.mobile.payment.Singleton.Companion.getInstance
...
class UPIPayment private constructor(
    ...
    class Builder {
        ...
        fun build(): UPIPayment {
            ...
            checkNotNull(payment) { "com.loan.cllo.upi.models.Payment Details must be initialized before build()" }
