...
class EasyUpiPayment constructor(
    ...
    private val mPayment: com.loaner.mobile.model.Payment
) {
        ...
        if (mActivity is AppCompatActivity) {
            activityLifecycleObserver = object : LifecycleObserver {
                ...
                fun onDestroyed() {
                    ...
                    Singleton.getInstance()?.setListener(null)
                }
            }
    ...
    fun startPayment() {
        ...
        val payIntent = Intent(mActivity, PaymentsUIActivity::class.java).apply {
            putExtra(PaymentsUIActivity.EXTRA_KEY_PAYMENT, mPayment)
        }
    ...
    fun setPaymentStatusListener(mListener: PaymentStatusListener) {
        Singleton.getInstance()?.setListener(mListener)
    }
    ...
    class Builder(private val activity: Activity) {
        ...
        fun build(): EasyUpiPayment {
            ...
            val payment = com.cash.loanpro.model.Payment(
                currency = "INR",
                vpa = payeeVpa!!,
                name = payeeName!!,
...
@JvmSynthetic
fun EasyUpiPayment(activity: Activity, initializer: EasyUpiPayment.Builder.() -> Unit): EasyUpiPayment {
    return EasyUpiPayment.Builder(activity).apply(initializer).build()
}